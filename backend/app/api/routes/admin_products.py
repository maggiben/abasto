...
from app.schemas.csv_import import ProductCsvImportResult
from app.schemas.product import ProductCreate, ProductPublic, ProductUpdate, ProductWithInventory
from app.services.audit_service import record as audit_record
from app.services.product_csv import format_export_filename, parse_import_csv, products_to_csv_bytes
...
@router.post("/import", response_model=ProductCsvImportResult)
async def import_products_csv(
    ...
    created, updated = await apply_import_rows(session, rows)
    await audit_record(
        session,
        ...
        entity_type="product",
        entity_id=None,
        payload={"rows": len(rows), "created": created, "updated": updated},
    )
